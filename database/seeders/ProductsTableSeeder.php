    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            [
                ...
                'category' => 'Fluids',
                'description' => 'Sold per Liter.AMSOIL Premium Protection Synthetic Motor Oil is formulated to provide superior protection and performance in a wide variety of demanding applications.
                Its unique combination of synthetic base oils and a superior additive package results in a formulation that exceeds the requirements of most gasoline or diesel applications that call for 10W-40 or 20W-50 motor oil.
                Premium Protection Synthetic Motor Oil is ideal for high-mileage vehicles and high-stress vehicles subject to hot temperatures, heavy hauling, trailer pulling or off-road use.
                It provides the extra anti-wear protection required by engines with flat-tappet cams and high-tension valve springs.
                AMSOIL Premium Protection Synthetic Motor Oil offers flexibility and performance beyond conventional oils.',
                'price' => 650,
                'stockquantity' => 999,
                'criticallevel' => 24,
            ],
            ...
            [
                ...
                'category' => 'Suspension',
                'description' => 'Sold per Set.
                Coilovers are designed and developed for motoring enthusiasts desiring excellent handling without sacrificing ride comfort.
                This suspension system features 33-way adjustable dampening settings and full length ride height adjustment to meet every driver\'s handling desires.
                Pillowball mounts and adjustable camber plates are included for front and rear on most kits to increase steering response, while aluminum upper mounts with hardened rubber bushings are used on some applications for noise reduction.
                This suspension system is ideal for daily driving and occasional track use. Vehicle ride height can be lowered at least 2.5" or more on most application.
                A steel lower bracket is utilized for MacPherson strut type to increase rigidity for safety (where applicable).
                For most MacPherson strut models, the brake line bracket is welded manually perfectly to the steel lower mount.
                A high quality forged alloy aluminum lower bracket is used for Double-A Arm strut type (where applicable).
                The steel/aluminum lower bracket is processed with electroplated/ anodized surface treatment to prevent corrosion or rust in the harsh conditions of motorsport.
                The vehicle ride height can be adjusted easily with the lower bracket by winding up and down to drop and raise. With the lower bracket, it allows maximum suspension travel without affecting the shock stroke.
