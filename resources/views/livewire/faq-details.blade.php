<div class="border-black border-1 w-full rounded-lg">
    ...
    <div>
        <div class="p-2 flex flex-col h-full justify-center">
            ...
            <textarea class="w-full h-30 p-2 mx-1 border rounded-md border-gray-300 focus:outline-none focus:border-blue-500" rows="4">{{ $selectedFaq->question }}</textarea>

            <div class="text-sm h-min mb-1">
                Answer:
            </div>
            <textarea class="w-full h-30 p-2 mx-1 border rounded-md border-gray-300 focus:outline-none focus:border-blue-500" rows="4">{{ $selectedFaq->answer }}</textarea>
        </div>
    </div>
    {{-- Bottom --}}
    ...
    <div class="w-full mt-3 flex justify-center">
        <button wire:click="createFaq" type="submit" class="h-10 px-4 flex flex-row items-center justify-center rounded-lg bg-orange-500 ml-3 border-1 border-black text-white text-sm font-semibold text-spacing mb-3">
            Create FAQ
