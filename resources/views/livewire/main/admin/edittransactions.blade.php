                    ...
                    <div class="w-full h-full text-right flex">
                        <div class="w-full h-full flex flex-col">
                            ...
                            <div class="w-full mt-5 flex justify-center">
                                <button type="submit" class="h-10 w-60  items-center justify-center rounded-lg bg-orange-500  border-1 border-black text-white text-sm font-semibold text-spacing flex flex-row">
                                    Save Changes
                    ...
                    <div class="w-full h-full flex flex-col">
                        ...
                        <div class="w-full h-96 overflow-y-auto mb-3" id="edittransactions-container"">
                            ...
                            <li class="w-full flex justify-center select-none px-2">
                                ...
                                <label class="w-11/12 py-2 my-1 rounded border-2 border-gray shadow-sm text-sm flex items-center" for="productId1">
                                    <ul class="flex flex-row w-full">
                                        <li class="w-6/12 text-center text-xs flex items-center justify-center">
                                            <div class="flex items-center"> <!-- Wrapping content in a flex container -->
                                                <img src="{{ asset('assets/BC Racing M1 Series.png') }}" class="w-24 h-20 ml-[-2rem]">
                                                <div class="ml-2"> <!-- Adding margin to separate image and text -->
                                        ...
                                        <li class="w-2/12 text-center flex items-center justify-center text-sm">₱ 28,500.00</li>
                                        <li class="w-2/12 text-center flex items-center justify-center text-sm">2</li>
                                        <li class="w-2/12 text-center flex items-center justify-center text-sm">₱ 57,000.00</li>
                            ...
                            <ul class="flex flex-row w-full rounded border border-gray-500 px-2 py-2">
                                <li class="w-6/12 text-center text-xs flex items-center justify-center ">
                                    <div class="flex items-center"> <!-- Wrapping content in a flex container -->
                                        ...
                                        <div class=""> <!-- Adding margin to separate image and text -->
                                            ...
                                            <input class="w-5/6 h-10 flex items-center text-xs" type="text" value="23">
                                        </div>
                                        <img src="{{ asset('assets/BC Racing M1 Series.png') }}" class="w-24 h-20 ml-[-1rem]">
                                    </div>
                                </li>
                                <li class="w-3/12 text-center flex items-center justify-center text-xs ">Random Item</li>
                                <li class="w-2/12 text-center flex items-center justify-center text-xs ">
                                    <div class=""> <!-- Adding margin to separate image and text -->
                                        ...
                                        <input class="w-5/6 h-10 flex items-center text-xs" type="number" value="23">
                                    </div>
                                </li>
                                <li class="w-3/12 text-center flex items-center justify-center text-sm">
                                    <button type="submit" class="h-10 w-60 items-center justify-center rounded-lg bg-orange-500  border-1 border-black text-white text-xs  font-semibold text-spacing flex flex-row">
                                        Add Item
