    ...
    <div class="flex flex-row items-center mt-4">
        <div class="w-1/2 text-center">
            <div class="flex justify-between items-center w-full h-full px-3">
                <a class="hover:bg-slate-300 py-1 px-2 rounded-full" href="{{ $faqs->url(1) }}">
                ...
                <a class="hover:bg-slate-300 py-1 px-2 rounded-full" href="{{ $faqs->previousPageUrl() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <div
                    ...
                    {{ $faqs->currentPage() . '/' . $faqs->lastPage() }}
                </div>
                <a class="hover:bg-slate-300 py-1 px-2 rounded-full" href="{{ $faqs->nextPageUrl() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <a class="hover:bg-slate-300 py-1 px-2 rounded-full" href="{{ $faqs->url($faqs->lastPage()) }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
