<div class="absolute top-0 left-0 w-full h-full flex items-center justify-center border">
    ...
    <div class="bg-white z-10 p-3 rounded-lg w-80 h-full flex flex-col" style="max-height: 400px;">
        <div class="flex-1 overflow-y-auto">
            <div class="w-full text-center text-lg font-bold mb-3">Product Categories</div>
            <table class="w-full text-left">
                <thead>
                    <tr>
                        <td class="w-10/12">Category</td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button
                                class="h-full w-full p-2 flex items-center justify-center hover:bg-gray-200 rounded-md">
