    ...
    <div class="w-full h-full flex flex-col">
        ...
        <div class=" flex flex-1 w-full">
            <div class="w-2/5 text-left text-xs pr-2">
                ...
                <div class="text-left text-xs my-2">
                    <span class="font-semibold">Name:</span> {{ $selectedTransaction->firstName }} {{ $selectedTransaction->lastName }}
                </div>
                <div class="text-left text-xs my-2">
                ...
                <div class="text-left text-xs my-2">
                    <span class="font-semibold">Preferred Service:</span> {{ $selectedTransaction->preferredService }}
                </div>
