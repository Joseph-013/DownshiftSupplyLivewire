<div class="border-black border-1 w-full rounded-lg text-right p-3 flex" style="height: 65vh;">
    <div class="w-full h-full flex flex-col">
        ...
        <div class="w-full h-96 overflow-y-auto" id="online-orders-container">
            <div class=" flex flex-1 w-full">
                ...
                <div class="text-left text-xs my-2">
                    ...
                    <div class="text-left text-xs my-2">
                        <span class="font-semibold">Payment Opt:</span>
                        {{ isset($selectedTransaction) ? $selectedTransaction->paymentOption : '--' }}
                    </div>
                    <div class="text-left text-xs my-2">
                ...
                <div class="w-2/5 text-left text-xs px-2 mx-1">
                    ...
                    <div id="imageDiv"
                        ...
                        style="height: 30vh;" onclick="showOverlay()">
                        @if (isset($selectedTransaction))
                            <img id="image"
        ...
        <div class="w-full text-xs text-right pr-1 flex items-center">
            <div class="w-1/2 flex ml-20">
                <span class="font-semibold text-xs flex items-center mr-2">Status: </span>
                {{ isset($selectedTransaction) ? $selectedTransaction->status : '--' }}
