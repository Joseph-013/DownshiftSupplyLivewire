                ...
                @if ($transaction->purchaseType === 'Online')
                    <li class="w-full flex justify-center select-none px-2" wire:key="{{ $transaction->id }}">
                        ...
                        ">
                                ...
                                <li
                                    class="w-2/12 text-center text-xs flex justify-center items-center rounded-full h-7 w-7 ml-1 shadow-md
                                    ...
                                    @switch($transaction->status)
                                        @case('Processing')
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                ...
                                                viewBox="0 0 16 16" style="filter: drop-shadow(0 0 3px rgba(0, 0, 0, 0.8));">
                                                <path
                                        ...
                                        @case('On Hold')
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-pause-circle text-white" viewBox="0 0 16 16"
                                        ...
                                        @case('Completed')
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-check-circle text-white" viewBox="0 0 16 16"
                                                style="filter: drop-shadow(0 0 3px rgba(0, 0, 0, 0.8));">
                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                                                <path
