<div class="border-black border-1 w-full rounded-lg">
    ...
    <button wire:click="deleteProduct" type="submit" class="h-10 flex-1 items-center justify-center rounded-lg bg-red-600 mr-3 border-1 border-black text-white text-sm font-semibold text-spacing flex flex-row">
        Delete
    ...
    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
        <div class="bg-gray-100 p-6 rounded-lg">
            <p class="text-xs text-gray-800 mb-4">Are you sure you want to delete this product?</p>
            <div class="flex justify-end">
                <button type="button" class="px-4 py-2 bg-gray-400 text-white rounded-md mr-2">No</button>
                <button type="button" class="px-4 py-2 bg-red-600 text-white rounded-md">Yes</button>
            </div>
        </div>
    </div>
    <button wire:click="updateProduct" type="submit" class="h-10 flex-1 items-center justify-center rounded-lg bg-sky-600 ml-3 border-1 border-black text-white text-sm font-semibold text-spacing flex flex-row">
        Update
