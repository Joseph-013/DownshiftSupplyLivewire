    ...
    <div class="w-screen h-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col h-full">
            ...
            <div class="w-full flex flex-row items-center justify-between mt-3 mb-4">
                ...
                <div class="flex-1">
                    <form action="{{ route('admin.onlinetransactions.search') }}" method="GET" class="flex flex-row">
                        <div class="mx-2 flex flex-row w-full">
                            <input name="search" class="flex-1 focus:border-orange-500 outline-none rounded-s-lg border-gray-500 border-l-2 border-t-2 border-b-2 border-e-0 h-full" type="text" />
