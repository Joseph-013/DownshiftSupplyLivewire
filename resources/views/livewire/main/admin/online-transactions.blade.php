    ...
    <div class="w-screen h-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col h-full">
            ...
            <div class="w-full flex flex-row items-center justify-between mt-3 mb-4">
                ...
                <div class="flex-1">
                    <form id="searchForm" action="{{ route('admin.onlinetransactions.search') }}" method="GET" class="flex flex-row">
                        <div class="mx-2 flex flex-row w-full">
                            <input name="search" id="searchInput" class="flex-1 focus:border-orange-500 outline-none rounded-s-lg border-gray-500 border-l-2 border-t-2 border-b-2 border-e-0 h-full" type="text" />
                        ...
                        <button type="button" class="mx-2 rounded-lg border-gray-500 border-2 px-3 text-sm hover:bg-gray-200 flex items-center"><svg class="svg-icon mr-2" style="width: 1.2em; height: 1.2em; fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
