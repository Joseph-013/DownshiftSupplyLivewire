    ...
    @if ($showOverlay)
        <div id="overlay"
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-xl mb-4 text-center">Have you received order '{{ $transaction->id }}' yet?</h2>
                <p class="text-sm text-gray-600 mb-4 text-center">It's been {{ $daysEllapsed }} days since order
                    '{{ $transaction->id }}' was in
                    transit.</p>
