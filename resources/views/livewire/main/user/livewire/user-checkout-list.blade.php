                    ...
                    <div class="w-full h-full flex flex-col">
                        <div class="w-full flex-row px-5">
                            <ul class="flex flex-row w-full mt-3">
                                ...
                                <li class="w-2/12 text-right text-xs font-semibold">Qty</li>
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr class="w-full my-1 select-none flex justify-center">
                                        ...
                                        <td class="w-full py-2 my-1 px-3 rounded-full border-2 border-gray shadow-sm text-sm flex items-center"
                                            for="productId1">
