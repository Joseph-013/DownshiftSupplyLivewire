                            ...
                            <div class="w-full h-96 overflow-y-auto flex-row" id="questions-container">
                                <ul class="flex flex-row w-full mb-3">
                                    <li class="w-2/4 text-left text-sm px-3">
                                        ...
                                        <div class="my-1">
                                            <span class="font-medium">Shipping Address:</span><br> 615 W Greenfield St. Valley Center, Kansas(KS), 67147
                                        </div>
                                    </li>
                                    <li class="w-2/4 text-left text-sm px-3">
                                        <div class="my-1 mt-2">
                                    ...
                                    <div class="w-full h-full flex flex-col">
                                        ...
                                        <div class="w-full flex-row px-5 my-2">
                                            <ul class="flex flex-row w-full">
                                                ...
                                                <span class="font-semibold mr-5">Shipping Fee: </span> ₱ 200.00</li>
                                            </ul>
                                        </div>
