                        ...
                        <div class="w-full h-full flex flex-col">
                            ...
                            <ul class="flex flex-row w-full">
                                ...
                                <li class="w-3/12 px-2 text-left text-sm">
                                    <img src="{{ asset('assets/BC Racing M1 Series.png') }}" class="w-30 h-30 rounded-lg border-gray-500 border-1">
                                    <div class="w-full h-10 flex items-center">
                                        <ul class="flex flex-row w-full">
                                            ...
                                            <li class="w-1/4 text-left text-sm mt-4 flex justify-center">
                                                <svg class="svg-icon mt-3" style="width: 2.5em; height: 2.5em; vertical-align: middle; fill: #fb923c; overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
