<div class="flex-1">
    ...
    <form wire:submit.prevent="submitSearch" class="flex flex-row">
        <div class="mx-2 flex flex-row w-full">
            <input wire:model="search" class="flex-1 focus:border-orange-500 outline-none rounded-s-lg border-gray-500 border-l-2 border-t-2 border-b-2 border-e-0 h-full w-full" type="text" />

            <button type="button" wire:click.prevent="clearSearch" class="rounded-e-lg border-gray-500 border-r-2 border-t-2 border-b-2 h-full w-10 flex items-center justify-center">
        ...
        <div class=" dropdown mx-2 px-3 border-gray-500 border-2 rounded-lg flex justify-center items-center hover:bg-gray-200 text-sm">
            ...
            <div class="dropdown-content flex-col w-36">
                <button wire:click="" class="hover:bg-gray-200 h-7 ">Category 1</button>
                <button wire:click="" class="hover:bg-gray-200 h-7 ">Category 2</button>
                <button wire:click="" class="hover:bg-gray-200 h-7 ">Category 3</button>
            </div>
        </div>


        <button type="submit" class="mx-2 rounded-lg border-gray-500 border-2 px-3 text-sm hover:bg-gray-200 flex items-center"><svg class="feather feather-search" fill="none" height="18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
